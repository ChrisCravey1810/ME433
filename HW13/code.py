...
ipv4 =  ipaddress.IPv4Address("192.168.50.42")
...
def webpage():
    ...
    <form accept-charset="utf-8" method="POST">
    <button class="button" name="STOPWATCH" value="TRUE" type="submit">STOPWATCH</button></a></p></form>
    </body></html>
    """
    return html
...
def buttonpress(request: HTTPRequest):
    ...
    if "OFF" in raw_text:
        ...
        led.value = False
    if "TRUE" in raw_text:
        #Print stopwatch value, restart
        print("Time is: " , time.monotonic())
